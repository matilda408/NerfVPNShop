...
event-subscription =
    ...
    { $is_hour ->
    [1]
    <b>⚠️ Внимание! Ваша подписка закончится через { unit-hour }.</b>
    *[0]
    ...
    *[1]
    { $is_hour ->
    [1]
    <b>⚠️ Внимание! Ваш бесплатный пробник закончится через { unit-hour }.</b>
    *[0]
    ...
    .trial-not-connected =
    Заметили, что вы получили ключ, но не использовали его. Лучший VPN всего в одном шаге, просто вставьте ключ в приложение! 👀

    <code>{ $subscription_url }</code>

    Или воспользуйтесь инструкцией по настройке:
